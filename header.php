...
<head>
  ...
  <?php wp_head(); ?>
	...
	<!-- Favicon and Feed -->
	<link rel="shortcut icon" type="image/png" href="<?php echo get_template_directory_uri(); ?>/monkey6.png">
...
<link rel="menu-homepage" href="<?php echo get_template_directory_uri(); ?>/http://cdnjs.cloudflare.com/ajax/libs/foundicons/3.0.0/foundation-icons.css" /> 
